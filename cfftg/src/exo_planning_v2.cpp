	...
	*/
	while(ros::ok()){
		if(cfftg_start){
			...
			vector<vector<Point>> bundle = cfftg_sagittal_v2(thigh_length, shin_length,  rear_foot_length, front_foot_length, endpoint + rear_foot_length, hip_height, pivot, knee_ang, obstacle_shape, step_time,0.05);
